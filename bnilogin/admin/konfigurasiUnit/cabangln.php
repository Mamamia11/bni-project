        ...
        <table class="table table-stripped table-bordered" id="myTable">
            ...
            <form id="form" action="../../tambah.php" method="POST">
                   ...
                   <span>Tambah Sektor</span>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="modalCabangLn" tabindex="-1" aria-labelledby="exampleModalCabangLn" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCabangLn">Input Cabang Ln</h5>
