<?php 
    ...
    $kodesektor = query("SELECT * FROM perusahaan")
        ...
        <ul class="list-unstyled components">
            <li class="active">
                ...
                <ul class="collapse list-unstyled" id="homeSubmenu">
                    ...
                    <li>
                        <a href="#"><i class="fas fa-fw fa-wrench"></i> Perusahaan Anak</a>
                    </li>
                    <li>
    ...
    <div id="content">
        ...
        <table class="table table-stripped table-bordered" id="myTable">
            <thead>
                    <tr>
                        <td>No.</td>
                        <td>KODE PERUSAHAAN ANAK</td>
                        <td>NAMA PERUSAHAAN ANAK</td>
                        <td>NAMA DIREKTUR UTAMA</td>
                        <td>STATUS</td>
                        <td>ACTION</td>
                    </tr>
                    </thead>
                    ...
                    <tr>
                        ...
                        <td><a href="../../clean.php?id=<?= $kode["id"]; ?>&folder=konfigurasiUnit&table=perusahaan" onclick="return confirm('Hapus Data?');" class="btn btn-md btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>&nbsp;
                        <a href="../../edit.php?id=<?=$kode["id"];?>&folder=konfigurasiUnit" data-bs-toggle="modal" data-id="<?= $kode["id"]?>" data-bs-target="#modalPa" data-href="Pa" class="editData btn btn-md btn-primary"> <i class="fas fa-pencil-alt" aria-hidden="true"></i> </a> </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
                    </tbody>
                   ...
                   <span>Tambah Sektor</span>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nm_pa" name="nm_pa" required>
                            </div>
                        <div class="mb-3">
                            <label for="nm_dir" class="form-label">Nama Direktur UTAMA</label>
